...
static subscriber_t *sub_cmd,*sub_ins,*sub_gim,*sub_referee;
...
static void trans_sub_init(void)
{
    ...
    sub_referee = sub_register("referee_fdb", sizeof(struct referee_msg));//订阅裁判系统
...
void judge_color()
{
    if(referee_fdb.robot_status.robot_id < 10)
